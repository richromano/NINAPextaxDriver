...
namespace Rtg.NINA.NinaPentaxDriver.NinaPentaxDriverDrivers {
    ...
    /// </summary>
    public class NinaPentaxDriverWeatherDriver : BaseINPC, IWeatherData {
        public NinaPentaxDriverWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"NinaPentaxDriver Weather Data ({deviceId})";
        ...
        public string Category => "NinaPentaxDriver Weather Driver";
