...
namespace Rtg.NINA.NinaPentaxDriver.NinaPentaxDriverTestCategory {
    /// <summary>
    ...
    [ExportMetadata("Category", "NINA Pentax Driver")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class NinaPentaxDriverInstruction : SequenceItem {
        /// <summary>
        ...
        public NinaPentaxDriverInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public NinaPentaxDriverInstruction(NinaPentaxDriverInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new NinaPentaxDriverInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(NinaPentaxDriverInstruction)}, Text: {Text}";
        }
    }
}