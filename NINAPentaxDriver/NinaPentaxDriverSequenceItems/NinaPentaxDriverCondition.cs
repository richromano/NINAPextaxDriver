...
namespace Rtg.NINA.NinaPentaxDriver.NinaPentaxDriverTestCategory {
    ...
    public class NinaPentaxDriverCondition : SequenceCondition {
        /// <summary>
        ...
        public NinaPentaxDriverCondition() {
            IsTruthy = true;
        }
        ...
        public override object Clone() {
            return new NinaPentaxDriverCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(NinaPentaxDriverCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}