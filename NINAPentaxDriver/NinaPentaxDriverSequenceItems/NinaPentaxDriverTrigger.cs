...
namespace Rtg.NINA.NinaPentaxDriver.NinaPentaxDriverTestCategory {
    ...
    public class NinaPentaxDriverTrigger : SequenceTrigger {
        /// <summary>
        ...
        public NinaPentaxDriverTrigger() {
        }

        public override object Clone() {
            return new NinaPentaxDriverTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(NinaPentaxDriverTrigger)}";
        }
    }
}